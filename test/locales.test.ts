...
test('i18n locales', () => {
    // it('should have matching keys', () => {
        ...
        const reference_keys: Set<string> = keys.get(reference_locale) || new Set<string>();
        for(let i = 1; i < locales.length; i++) {
            ...
            if (diffrence.size > 0) {
                console.error(`Locale ${locale} has different keys than ${reference_locale}:`, diffrence);
            }
